...
/**
 * Browser: the realtime gateway URL. A build-time value wins (dev compose,
 * local builds); otherwise HTTPS pages use the same-origin `/ws` proxy and
 * plain-HTTP dev pages the sibling gateway port 3001.
 */
